...
run-jar: build
	java -jar target/spring-starbucks-api-2.1.jar
...
docker-push:
	docker login
	docker build -t $(account)/spring-starbucks-api:v2.1 -t $(account)/spring-starbucks-api:v2.1 .
	docker push $(account)/spring-starbucks-api:v2.1
